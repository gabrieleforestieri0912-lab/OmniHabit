...
import { Hexagon, Github, Twitter, Mail, Heart, ArrowUp } from 'lucide-react';
...
export default function Footer({ onNavClick }) {
  ...
  return (
    <footer className="relative border-t border-white/15 bg-[#0a0a0a]">
      <div className="mx-auto max-w-[1600px] px-5 sm:px-8 md:px-12 py-14 md:py-20">
