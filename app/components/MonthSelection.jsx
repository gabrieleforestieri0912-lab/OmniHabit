...
import { Calendar, LayoutGrid, Zap, X, Plus, Trash2, CheckCircle2, Circle, TrendingUp } from 'lucide-react';
...
export default function MonthSelection({
  ...
  return (
    <section id="months" className={`relative bg-[#0a0a0a] px-5 sm:px-8 md:px-12 py-24 md:py-32 min-h-screen ${isQuartersView ? 'pt-20 md:pt-24' : ''}`}>
            ...
            >
              {months.map((m, i) => (
                <motion.button
                  ...
                  onClick={() => {
                    setSelectedMonth(m);
                    window.scrollTo({ top: document.getElementById('selected-month-details')?.offsetTop - 100 || 800, behavior: 'smooth' });
                  }}
                  ...
                  <div className="flex flex-col gap-3">
                    {qMonths.map((m, i) => (
                      <motion.button
                        ...
                        className={`group p-5 rounded-xl border transition-all duration-300 cursor-pointer text-left bg-white/10 border-white/15 hover:bg-white/15`}
            ...
            {selectedMonth && !isQuartersView && (
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-white/15 bg-white/10 p-6 md:p-10 backdrop-blur-md shadow-xl">
                  ...
                  <form onSubmit={addHabit} className="mb-8 relative z-10 flex flex-col sm:flex-row gap-3">
                    <input
                      type="text"
                      value={newHabit}
                      ...
                      {(habits[selectedMonth] || []).map((habit) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <button
                              onClick={() => toggleHabit(selectedMonth, habit._id, habit.completed, habit.streak)}
