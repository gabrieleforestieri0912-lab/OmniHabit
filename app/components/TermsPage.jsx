...
import { ArrowLeft, FileText, Scale, Users, CreditCard, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter">
                Termini di <span className="text-purple-500">Servizio</span>
              </h1>
